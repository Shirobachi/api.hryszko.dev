...
def test_make_move_422_1():
	response = client.post('/tictactoe/')
	response = client.post('/tictactoe/' + str(response.json()['code']) + "/dasd")
...
def test_draw_1_200_1():
	...
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/4")
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/0")
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/1")
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/7")
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/3")
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/5")
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/6")
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/2")
	response = client.post('/tictactoe/' + str(tmp.json()['code']) + "/8")
